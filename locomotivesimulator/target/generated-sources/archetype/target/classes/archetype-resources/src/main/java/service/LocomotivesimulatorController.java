...
import ${package}.model.LocationData;
import ${package}.model.Locomotive;
import ${package}.model.LocomotiveGatewayType;
import ${package}.model.RPMData;
import ${package}.model.TorqueData;
...
public class LocomotivesimulatorController implements EnvironmentAware {
	...
	@Value("${symbol_dollar}{timeseriesUrl}")
